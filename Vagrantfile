...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ankit-rakha-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/ljluka"
  #   chef.validation_client_name = "ljluka-validator"
  #   chef.validation_key_path = ".chef/ljluka-validator.pem"
  # end
end
